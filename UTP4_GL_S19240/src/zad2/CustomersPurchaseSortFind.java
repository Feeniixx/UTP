...
public class CustomersPurchaseSortFind {
    ...
    public void showSortedBy(String string) {
        Comparator<Purchase> byNazwisko = Comparator.comparing(Purchase::getName_surname).thenComparing(Purchase::getId);
        Comparator<Purchase> byKoszty = Comparator.comparing(Purchase::getKoszt).thenComparing(Purchase::getId);
        switch (string) {
            case "Nazwiska":
